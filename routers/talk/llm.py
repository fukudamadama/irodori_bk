...
def build_system_prompt() -> str:
    return (
        ...
        " - 『雑談』は50文字以内の相槌＋軽いひと言または質問返し。ユーザーの推し情報を自然に織り込む。\n"
        ...
        " - 『相談（投資）』では具体的な投資先の型（全世界株インデックス、先進国債券、つみたて枠、クレカ積立など）を少なくとも1つ入れる。金融情報は一般情報として提供し、最終判断は本人に委ねる一文を自然に添える（突き放さない）。\n"
